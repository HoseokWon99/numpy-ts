...
const kernels: Partial<Record<DType, ReduceFn>> = {
  float64: reduce_std_f64,
  float32: reduce_std_f32,
  int64: reduce_std_i64,
  uint64: reduce_std_u64,
  int32: reduce_std_i32,
  uint32: reduce_std_u32,
  int16: reduce_std_i16,
  uint16: reduce_std_u16,
  int8: reduce_std_i8,
  uint8: reduce_std_u8,
};
 ...
 */
export function wasmReduceStd(a: ArrayStorage): number | null {
