...
const scalarKernels: Partial<Record<DType, ScalarFn>> = {
  ...
  uint32: sub_scalar_i32,
  int16: sub_scalar_i16,
  uint16: sub_scalar_i16,
  int8: sub_scalar_i8,
  uint8: sub_scalar_i8,
  complex128: sub_scalar_c128,
  complex64: sub_scalar_c64,
};
 ...
 */
export function wasmSub(a: ArrayStorage, b: ArrayStorage): ArrayStorage | null {
 ...
 * Returns null if WASM can't handle.
 */
export function wasmSubScalar(a: ArrayStorage, scalar: number): ArrayStorage | null {
