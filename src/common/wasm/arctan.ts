 ...
 */
export function wasmArctan(a: ArrayStorage): ArrayStorage | null {
  ...
  if (dtype === 'float16') {
    ...
    arctan_f32(aPtr, outRegion.ptr, size);
  ...
  if (dtype === 'int64' || dtype === 'uint64') {
    ...
    (dtype === 'int64' ? arctan_i64 : arctan_u64)(aPtr, outRegion.ptr, size);
  ...
  arctan_f64(aPtr, outRegion.ptr, size);
