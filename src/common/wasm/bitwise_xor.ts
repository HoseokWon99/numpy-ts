...
const kernels: Partial<Record<DType, BinaryFn>> = {
  int64: bitwise_xor_i64,
  uint64: bitwise_xor_i64,
  int32: bitwise_xor_i32,
  uint32: bitwise_xor_i32,
  int16: bitwise_xor_i16,
  uint16: bitwise_xor_i16,
  int8: bitwise_xor_i8,
  uint8: bitwise_xor_i8,
};
...
export function wasmBitwiseXor(a: ArrayStorage, b: ArrayStorage): ArrayStorage | null {
