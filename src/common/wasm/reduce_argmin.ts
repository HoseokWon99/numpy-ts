...
const stridedKernels: Partial<Record<DType, StridedFn>> = {
  float64: reduce_argmin_strided_f64,
  float32: reduce_argmin_strided_f32,
  float16: reduce_argmin_strided_f32,
  int32: reduce_argmin_strided_i32,
  uint32: reduce_argmin_strided_u32,
  int16: reduce_argmin_strided_i16,
  uint16: reduce_argmin_strided_u16,
  int8: reduce_argmin_strided_i8,
  uint8: reduce_argmin_strided_u8,
};
 ...
 */
export function wasmReduceArgminStrided(
  a: ArrayStorage,
  outerSize: number,
  axisSize: number,
  innerSize: number
