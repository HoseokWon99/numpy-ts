 ...
 */
export function wasmCosh(a: ArrayStorage): ArrayStorage | null {
  ...
  if (dtype === 'int64' || dtype === 'uint64') {
    ...
    (dtype === 'int64' ? cosh_i64 : cosh_u64)(aPtr, outPtr, size);
    const outData = copyOut(
      outPtr,
      size,
