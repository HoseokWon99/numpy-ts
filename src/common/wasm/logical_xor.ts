...
import {
  ...
  logical_xor_i16,
  logical_xor_i8,
  logical_xor_scalar_f64,
  logical_xor_scalar_f32,
  logical_xor_scalar_i64,
  logical_xor_scalar_i32,
  logical_xor_scalar_i16,
  logical_xor_scalar_i8,
  logical_xor_f16,
  logical_xor_scalar_f16,
...
const binaryKernels: Partial<Record<DType, BinaryFn>> = {
  ...
  float16: logical_xor_f16 as unknown as BinaryFn,
  int64: logical_xor_i64,
  uint64: logical_xor_i64,
  int32: logical_xor_i32,
  uint32: logical_xor_i32,
  int16: logical_xor_i16,
  uint16: logical_xor_i16,
  int8: logical_xor_i8,
...
const scalarKernels: Partial<Record<DType, ScalarFn>> = {
  ...
  float16: logical_xor_scalar_f16 as unknown as ScalarFn,
  int64: logical_xor_scalar_i64,
  uint64: logical_xor_scalar_i64,
  int32: logical_xor_scalar_i32,
  uint32: logical_xor_scalar_i32,
  int16: logical_xor_scalar_i16,
  uint16: logical_xor_scalar_i16,
 ...
 */
export function wasmLogicalXor(a: ArrayStorage, b: ArrayStorage): ArrayStorage | null {
 ...
 * Returns null if WASM can't handle.
 */
export function wasmLogicalXorScalar(a: ArrayStorage, scalar: number): ArrayStorage | null {
