...
const kernels: Partial<Record<DType, ReduceFn>> = {
  ...
  uint32: reduce_count_nz_i32,
  int16: reduce_count_nz_i16,
  uint16: reduce_count_nz_i16,
  int8: reduce_count_nz_i8,
  uint8: reduce_count_nz_i8,
};
 ...
 */
export function wasmReduceCountNz(a: ArrayStorage): number | null {
