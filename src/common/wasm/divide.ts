...
// Integer-to-f64 binary kernels (int in, f64 out)
// uint types are intentionally excluded: the signed kernels misinterpret values > signed max.
// The JS fallback reads TypedArrays as unsigned (correct) and handles uint division.
...
// Integer-to-f64 scalar kernels (int in, f64 out)
